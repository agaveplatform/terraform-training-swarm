 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "git clone --depth 1 ${TRAINING_EVENT_GIT_URL}.git $TUTORIAL_FOLDER"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "    cp -rf $TUTORIAL_FOLDER/content/notebooks/*.ipynb $HOME/\n",
    "    \n",
    "    echo \"Tutorial notebooks successfully installed. Please go to the https://$VM_HOSTNAME/notebooks/00%20-%20Introduction.ipynb to begin the tutorial.\"\n",
    "else\n",
